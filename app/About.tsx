      ...
      >
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col justify-center pl-6">
            ...
            <div className="flex gap-8">
              {[{ n: "4.9★", l: "Rating" }, { n: "449+", l: "Reviews" }, { n: "5K+", l: "Happy Clients" }].map((s) => (
                <div key={s.l}>
        ...
        <div>
          ...
          <p className="text-zinc-400 leading-relaxed mb-5">
            Di CUTBAE, setiap sesi adalah ritual. Dari konsultasi awal sampai finishing touch — kami pastiin hasilnya konsisten, rapi, dan sesuai karakter lo.
          </p>
          <p className="text-zinc-400 leading-relaxed mb-8">
            Didukung barber berpengalaman dan suasana premium yang bikin lo betah, kami bukan sekadar barbershop biasa di Karawang — kami standar baru.
          </p>
          <div className="flex flex-wrap gap-3">
            {["Konsultasi Gratis", "Warm Towel", "Free Mineral Water", "Berpengalaman"].map((tag) => (
